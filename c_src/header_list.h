...
X(Allow - Events, 'u', allow_events, MultipleTokens)
...
X(Event, 'o', event, SingleTokenParams)
...
X(History - Info, 0, history_info, MultipleContactParams)
...
X(Min - SE, 0, min_se, SingleInteger)
X(Organization, 0, organization, TrimmedUtf8)
X(P - Access - Network - Info, 0, p_access_network_info, SingleTokenParams)
// X(P-Answer-State,                0, p_answer_state,                x)
X(P - Asserted - Identity, 0, p_asserted_identity, MultipleContactParams)
// X(P-Asserted-Service,            0, p_asserted_service,            x)
X(P - Associated - URI, 0, p_associated_uri, MultipleContactParams)
X(P - Called - Party - ID, 0, p_called_party_id, SingleContactParams)
// X(P-Charging-Function-Addresses, 0, p_charging_function_addresses, x)
X(P - Charging - Vector, 0, p_charging_vector, SingleTokenParams)
...
X(P - Preferred - Identity, 0, p_preferred_identity, MultipleContactParams)
...
X(P - Served - User, 0, p_served_user, SingleContactParams)
// X(P-User-Database,               0, p_user_database,               x)
X(P - Visited - Network - ID, 0, p_visited_network_id, MultipleTokenParams)
X(Path, 0, path, MultipleContactParams)
...
X(Privacy, 0, privacy, MultipleTokens)
...
X(RAck, 0, rack, Cseq)
X(Reason, 0, reason, MultipleTokenParams)
X(Record - Route, 0, record_route, MultipleContactParams)
// X(Recv-Info,                     0, recv_info,                     x)
// X(ReferSub,                      0, refer_sub,                     x)
X(Refer - To, 'r', refer_to, SingleContactParams)
X(Referred - By, 'b', referred_by, SingleContactParams)
...
X(RSeq, 0, rseq, SingleInteger)
X(Security-Client,               0, security_client,               TrimmedUtf8)
X(Security-Server,               0, security_server,               TrimmedUtf8)
X(Security-Verify,               0, security_verify,               TrimmedUtf8)
X(Server, 0, server, TrimmedUtf8)
X(Service - Route, 0, service_route, MultipleContactParams)
...
X(Subscription - State, 0, subscription_state, SingleTokenParams)
